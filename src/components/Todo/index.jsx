...
function Todo() {
    ...
    function handleAdd(e) {
        e.preventDefault();
        if (todo) {
            dispatch(add_item({ id: ids, title: todo }));
            setTodo("");
            setIds(ids + 1);
        }
    }
                    ...
                    <div className='items'>
                        ...
                        <table>
                            ...
                            <tbody>
                                {
                                    todoArr.map((item) => (
                                        <Tr editId={editId} item={item} editText={editText} setEditText={setEditText} handleEditUpdate={handleEditUpdate} handleEdit={handleEdit} dispatch={dispatch} remove_item={remove_item} key={item.id} />
                                    ))
                                }
